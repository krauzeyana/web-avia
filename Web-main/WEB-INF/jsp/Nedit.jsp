...
<c:choose>
    <c:when test="${not empty object}">
        ...
        <c:set var="text" value="${object.text}" />
        <c:set var="image" value="${object.image}" />
    </c:when>
    <c:otherwise>
        <c:set var="id" value='' />
    ...
    <div class=" container-fluid align-items-center">
        <div class="row justify-content-center ">
            <div class="col-12 col-sm-10 col-md-8 col-lg-6">
                ...
                <form class="form registration" id="form" action="Nsave.html?page=${page}" method="post" onsubmit="return chNews()">
                    ...
                    <div class="form-group row">
                        <label for="login" class="col-sm-2 col-form-label">Text</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="text" name="text" value="${text}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="login" class="col-sm-2 col-form-label">Image</label>
                        <div class="col-sm-10">
                    ...
                    <A href="news.html?page=${page}">Cancel</A>
