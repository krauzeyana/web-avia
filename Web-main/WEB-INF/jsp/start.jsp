...
<BODY>
    ...
    <div class=" container-fluid align-items-center ">
                ...
                <tbody>
                    <c:forEach var="object" items="${objects}">
                        <TR>
                            ...
                            <td>${object.text}</td>
                            <td>${object.image}</td>
                            <TD><A href="Nedit.html?id=${object.id}&page=${page}">&#128393;</A></TD>

                            <td><a href="Ndelete.html?id=${object.id}&page=${page}">&#128937;</a></td>
                        </tr>
                    </c:forEach>
            </TABLE>
        </FORM>
        <div class="col-3 col-sm-2 col-md-2 col-lg-1">
            <select onchange="window.location.href=this.options[this.selectedIndex].value" class="form-control"
                ...
                <c:choose>
                        ...
                        <c:forEach var="id" begin="0" end="${allId-1}" step="5">
                            ...
                            <c:choose>
                                <c:when test="${i eq page}">
                                    <option selected value='news.html?page=${i}'>${i}</option>
                                </c:when>
                                <c:otherwise>
                                    <option value='news.html?page=${i}'>${i}</option>
                                </c:otherwise>
                            </c:choose>
                    ...
                    <c:otherwise>
                        <option value='news.html?page=1'>1</option>
                    </c:otherwise>
                </c:choose>
        ...
        <br>
        <div class="col-3 col-sm-2 col-md-2 col-lg-2"><A href="Nedit.html?page=${page}">Add</A></div>
