...
<head>
    ...
    <title>Найти авиабилеты, бронирование – Глобал - Авиакомпания Республики Беларусь</title>

    <meta name="description"
        content="Стоимость перелетов, онлайн бронирование билетов на самолет от компании «Глобал»" />
</head>
    ...
    <div class="container col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">
        ...
        <div class="container_content">
            <div class="content__logo">
                ...
                <h1 class="content__text col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">Поиск и покупка билетов</h1>
            ...
            <div class="content__find col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">
                ...
                <form class="content__form col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12" action="main.html"
                    ...
                    <div class="content__direction col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">
                        <c:choose>
                            <c:when test="${direction eq 2}">
                                <input class="content__direction-one" name="direction" type="radio" value="1">В одну
                                сторону
                                <input class="content__direction-two" name="direction" type="radio" checked
                                    value="2">Туда-обратно
                            </c:when>
                            <c:otherwise>
                                <input class="content__direction-one" name="direction" type="radio" checked value="1">В
                                одну
                                сторону
                    ...
                    <div class="content__data-from col-12 col-sm-12 col-md-12 col-lg-6 col-lx-6">
                        <label class="content__label-main" for="data-from">Дата туда</label>
                        <br>
                        <br>
                        <c:choose>
                            <c:when test="${1 eq 1}">
                                <input type="date" class=" col-11 col-sm-11 col-md-11 col-lg-2 col-lx-2" id="date-from"
                                    name="date-from" value="2019-03-21">
                            </c:when>
                            <c:otherwise>
                                <input type="date" class=" col-11 col-sm-11 col-md-11 col-lg-2 col-lx-2" id="date-from"
                                    name="date-from" value="2019-03-21">
            ...
            <c:if test="${not empty objects}">
                <div class="content__result-search-m col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">
                    <h3>Выберите рейс "Туда"</h3>
                    <h5>Цена за все рейсы включая налоги и сборы</h5>
        ...
        <p>
            Уважаемые Пользователи сайта!</p>
        <p>
            Публичное акционерное общество «Глобал — белорусские авиалинии» (далее «Глобал») готово предоставить Вам
            услуги по онлайн-бронированию и онлайн-оплате мест на рейсы Глобал в установленном порядке и на условиях,
            предусмотренных Правилами авиакомпании.
            Для оплаты бронирования можно использовать любую форму оплаты, доступную на сайте Глобал (банковская карта,
            платежные агенты или оплата в офисе). Доступные формы оплаты перечислены ниже:
        </p>
        <ul>
            <li>
            ...
            <li>
                − Офис Глобал (комиссия 50 бел. руб.)
            </li>
            <li>
                − Банковская карта
            </li>
