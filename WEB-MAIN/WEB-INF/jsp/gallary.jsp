...
<head>
    ...
    <title>Галерея- Глобал - Авиакомпания Республики Беларусь</title>
    ...
    <div class="container col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">
        ...
        <div class="container_content">
            <div class="content__logo">
                ...
                <h1 class="content__text col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">Галерея</h1>
                <h3 class="content__text__sm col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">Здесь собраны фотографии
                    всех наших авиалайнеров</h3>

            </div>
            <div class="content__line col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12 ">
                <c:if test="${not empty objects}">
                    <c:forEach var="ob" items="${objects}">
                        <img class="content__photo col-11 col-sm-11 col-md-5 col-lg-3 col-lx-3" src="${ob.path}" alt="">
                    </c:forEach>
                </c:if>
            </div>
                    ...
                    <c:if test="${allId > 6}">
                        <c:if test="${page eq 1}">
                            <li><a class="disabled" href=''>
                                    <<</a> </li> </c:if> <c:if test="${page != 1}">
                            <li><a href='gallary.html?page=${page-1}'>
                                    <<</a> </li> </c:if> </c:if> <c:if test="${allId!=0}">
                                        <c:set var="i" value="1" />
                                        <c:forEach var="id" begin="0" end="${allId-1}" step="6">
                                            <c:choose>
                                                <c:when test="${i eq page}">
                            <li class="pagAct"> <a href='gallary.html?page=${i}'>${i}</a></li>
                            </c:when>
                            <c:otherwise>
                                <li> <a href='gallary.html?page=${i}'>${i}</a></li>
                            </c:otherwise>
                            </c:choose>
                        ...
                        <c:if test="${allId > 6}">
                            ...
                            <c:if test="${page != endP}">
                                <li><a href='gallary.html?page=${page+1}'>>></a></li>
                            </c:if>
                        </c:if>
                </ul>
            </div>
